...
namespace API.Core
{
    public static class ContainerExtensions
    {
        public static void AddUseCases(this IServiceCollection services)
        {
            ...
            services.AddTransient<IGetCountryCitiesQuery, EfGetCountryCitiesQuery>();
            ...
            services.AddTransient<ICheckBookingAvailability, EfCheckBookingAvailabilityQuery>();
            services.AddTransient<CheckBookingAvailabilityValidator>();
            ...
            }).AddJwtBearer(cfg =>
            {
                ...
                cfg.Events = new JwtBearerEvents
                {
                    OnTokenValidated = context =>
                    {
                        ...
                        var storage = services.BuildServiceProvider().GetService<ITokenStorage>();
