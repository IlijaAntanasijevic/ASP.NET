...
namespace Implementation.UseCases
{
    ...
    */
    ...
    public class UseCaseHandler
    {
        ...
        //15 - Get All Apartments | 16 - Find Apartment | 25+ Lookup tables get all | 33 - booking availability

        private List<int> GloballyAllowed = new List<int> { 2, 3, 6, 4, 15, 16, 25,26,27,28,29,32, 33 };
